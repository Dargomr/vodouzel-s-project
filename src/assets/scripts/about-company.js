...
const certificationSectionCertificationsInnerBlock = document.querySelector(
  '.certification-section__certifications-inner-block',
)
...
certificationSectionLeftKey.addEventListener('click', (e) => {
  ...
  certificationSectionCertificationsInnerBlock.style['transform'] =
    `translateX(${-(certWidth + certMargin) * slideIndex}px)`
